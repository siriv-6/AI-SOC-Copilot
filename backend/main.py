...
# ============================================================
# MULTI-AGENT SOC COPILOT ENDPOINT
# ============================================================

@app.post("/soc-analysis")
def soc_analysis(alert: dict):

    try:

        print("\n============================================================")
        print("MULTI-AGENT SOC COPILOT ANALYSIS")
        print("============================================================")

        # --------------------------------------------------------
        # STEP 1: Run existing ML/Wazuh analysis
        # --------------------------------------------------------

        ml_analysis = alert_prediction_service.process_alert(
            alert
        )

        # --------------------------------------------------------
        # STEP 2: Convert existing analysis into standardized SOC data
        # --------------------------------------------------------

        incident = analysis_response_service.build_response(
            ml_analysis
        )

        # --------------------------------------------------------
        # STEP 3: Send incident to LangGraph Multi-Agent System
        # --------------------------------------------------------

        graph_result = soc_graph.invoke(
            {
                "incident": incident
            }
        )
        ...
        # --------------------------------------------------------
        # STEP 4: Return complete SOC Copilot result
        # --------------------------------------------------------
        ...
        return {
            ...
            "multi_agent_analysis": {
                ...
                "threat_analysis": graph_result.get(
                    "threat"
                ),

                "mitre_attack": graph_result.get(
                    "mitre"
                ),

                "explainability": graph_result.get(
                    "explanation"
                ),

                "response_recommendations": graph_result.get(
                    "response"
                )
            }
        }
        ...
        print("\n============================================================")
        print("MULTI-AGENT SOC ANALYSIS ERROR")
        print("============================================================")
